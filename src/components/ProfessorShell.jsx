...
const navItems = [
  { to: "/professor/inicio", label: "Início" },
  { to: "/professor/turmas", label: "Turmas" },
  { to: "/professor/materiais", label: "Materiais" },
  { to: "/professor/atividades", label: "Atividades" },
  { to: "/professor/questoes", label: "Questões" },
  { to: "/professor/desempenho", label: "Desempenho" },
  { to: "/professor/perfil", label: "Perfil" },
];
...
function isActiveRoute(currentPath, itemPath) {
  if (itemPath === "/professor/turmas") {
    return currentPath === itemPath || currentPath.startsWith("/professor/turmas/");
  }
