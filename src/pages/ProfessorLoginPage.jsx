    ...
    <main className="flex min-h-screen items-start justify-center bg-[#f5f5f5] px-4 pt-10 sm:pt-16">
      <div className="w-full max-w-[340px]">
        <div className="mb-4 flex justify-center">
          ...
          />
          <div className="hidden h-10 items-center justify-center text-lg font-bold text-slate-700">
            StudyHub
          </div>
        </div>

        <div className="rounded-[12px] border border-slate-300 bg-white px-4 py-4 shadow-sm">
          <h1 className="text-[15px] font-semibold text-slate-900">
            Login do Professor
          </h1>
          <p className="mt-1 text-[11px] text-slate-500">
            Acesse sua conta para gerenciar turmas, materiais e atividades
          </p>
